    ...
    Public Sub WorkerExecute()
        ...
        Try
            ...
            Do While Not lineread Is Nothing
                ...
                Try
                    tempprefix = prefix
                    If InStr(prefix, "@LINE@") > 0 Then
                        tempprefix = tempprefix.Replace("@LINE@", count_total)
                    End If
                    tempsuffix = suffix
                    If InStr(suffix, "@LINE@") > 0 Then
                        tempsuffix = tempsuffix.Replace("@LINE@", count_total)
                    End If

                    filewriter.WriteLine(tempprefix & lineread & tempsuffix)
